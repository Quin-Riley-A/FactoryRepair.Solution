...
namespace FactoryRepair.Controllers
{
  public class EngineersController : Controller
  {
    private readonly FactoryRepairContext _db;

    public EngineersController (FactoryRepairContext db)
    {
      _db = db;
    }
    ...
    public ActionResult Index()
    {
      List<Engineer> model = _db.Engineers
        .Include(engineer => engineer.EngineerName)
        .ToList();
      return View(model);
    }
